...
// New country codes!!!
    ...
    consteval array<double, numberOfCountries> initMaiCoefficients() {
        ...
        maiCoefficients[78] = 0.87690769 * 1.142 * 1.0294 * 1.022;  // TODO or 0.876907693 * 1.142 * 1.0294 * 1.022?
        ...
        maiCoefficients[103] = 1.096244868 * 1.147 * 1.0272 * 0.9991;  // TODO or 1.100490588 * 1.147 * 1.0272 * 0.9991?
        ...
        maiCoefficients[161] = 0.960952497 * 0.834 * 0.9163 * 0.962 * 0.98;  // TODO or 0.963766694 * 0.834 * 0.9163 * 0.962 * 0.98?
        maiCoefficients[174] = 1.012 * 1.004 * 1.00196;
        maiCoefficients[177] = 0.96 * 1.175 * 1.006 * 0.9989;  // TODO or 0.96 * 1.175 * 1.006 * 0.9985?
    ...
    consteval array<double, numberOfCountries> initHurdle_opt() {
        ...
        hurdle_opt[20] = 0.368054;
        hurdle_opt[24] = 8.51867;
        hurdle_opt[56] = 7.501;
        hurdle_opt[57] = 4;
        hurdle_opt[58] = 0.201;
        hurdle_opt[61] = 0.496952;
        hurdle_opt[68] = 50.9;
        hurdle_opt[69] = 9.78531;
        hurdle_opt[71] = 0.818859;
        hurdle_opt[74] = 2.08712;
        hurdle_opt[78] = 0.543845;
        hurdle_opt[87] = 18.8552;
        hurdle_opt[97] = 7.45029;
        hurdle_opt[99] = 6.63376;
        hurdle_opt[103] = 2.7;
        hurdle_opt[108] = 8.8;
        hurdle_opt[128] = 7.54654;
        hurdle_opt[129] = 0.401;
        hurdle_opt[130] = 58.717;
        hurdle_opt[141] = 150;
        hurdle_opt[161] = 0.301;
        hurdle_opt[174] = 3.08456;
        hurdle_opt[177] = 2.88708;
        hurdle_opt[183] = 8.56416;
        hurdle_opt[202] = 5.08613;
        hurdle_opt[203] = 3.01969;
        hurdle_opt[204] = 0.785857;
        return hurdle_opt;
    }
    ...
    consteval array<double, numberOfCountries> initAfforRate_opt() {
        ...
        afforRate_opt[20] = 2.46454;
        afforRate_opt[24] = 0.301724;
        afforRate_opt[56] = 7.53624;
        afforRate_opt[57] = 0.178468;
        afforRate_opt[58] = 0.934628;
        afforRate_opt[61] = 0.801715;
        afforRate_opt[68] = 4.05773;
        afforRate_opt[69] = 0.504609;
        afforRate_opt[71] = 1.92167;
        afforRate_opt[74] = 1.28153;
        afforRate_opt[78] = 0.69004;
        afforRate_opt[87] = 0.408741;
        afforRate_opt[97] = 0.351809;
        afforRate_opt[99] = 0.500844;
        afforRate_opt[103] = 0.708548;
        afforRate_opt[108] = 2.09293;
        afforRate_opt[128] = 0.559768;
        afforRate_opt[129] = 0.0163956;
        afforRate_opt[130] = 0.721315;
        afforRate_opt[141] = 1;
        afforRate_opt[161] = 11.5565;
        afforRate_opt[174] = 0.529406;
        afforRate_opt[177] = 4.32411;
        afforRate_opt[183] = 0.26396;
        afforRate_opt[202] = 0.230247;
        afforRate_opt[203] = 1.88306;
        afforRate_opt[204] = 3.38378;
    ...
    consteval array<double, numberOfCountries> initDeforRate_opt() {
        ...
        deforRate_opt[20] = 38.3123;
        deforRate_opt[24] = 0.0565156;
        deforRate_opt[56] = 0.38485;
        deforRate_opt[57] = 31.6544;
        deforRate_opt[58] = 1.37755;
        deforRate_opt[61] = 0.670866;
        deforRate_opt[68] = 46.7072;
        deforRate_opt[69] = 0.552849;
        deforRate_opt[71] = 101.025;
        deforRate_opt[74] = 22.149;
        deforRate_opt[78] = 2.56077;
        deforRate_opt[87] = 0.0386345;
        deforRate_opt[97] = 0.0607292;
        deforRate_opt[99] = 0.478023;
        deforRate_opt[103] = 500;
        deforRate_opt[108] = 500;
        deforRate_opt[128] = 0.190799;
        deforRate_opt[129] = 3.06463;
        deforRate_opt[130] = 14.2084;
        deforRate_opt[141] = 1;
        deforRate_opt[161] = 217.651;
        deforRate_opt[174] = 0.241311;
        deforRate_opt[177] = 5.71742;
        deforRate_opt[183] = 0.337474;
        deforRate_opt[202] = 0.0766723;
        deforRate_opt[203] = 5.45089;
        deforRate_opt[204] = 11.6432;
    ...
    consteval array<array<double, 4>, numberOfCountries> initEmissionsResUseSust1() {
        ...
        emissionsResUseSust1[17][2] = 0.0489;
        emissionsResUseSust1[17][3] = 0.0000;   // Austria
        emissionsResUseSust1[20][0] = 0.2200;
        emissionsResUseSust1[20][1] = 0.0733;
        emissionsResUseSust1[20][2] = 0.0489;
        emissionsResUseSust1[20][3] = 0.0122;   // Belgium
        emissionsResUseSust1[24][0] = 0.0733;
        emissionsResUseSust1[24][1] = 0.0733;
        emissionsResUseSust1[24][2] = 0.0367;
        emissionsResUseSust1[24][3] = 0.0122;   // Bulgaria
        emissionsResUseSust1[97][0] = 0.0733;
        emissionsResUseSust1[97][1] = 0.0489;
        emissionsResUseSust1[97][2] = 0.0122;
        emissionsResUseSust1[97][3] = 0.0000;   // Croatia
        emissionsResUseSust1[57][0] = 0.3667;
        emissionsResUseSust1[57][1] = 0.1467;
        emissionsResUseSust1[57][2] = 0.1222;
        emissionsResUseSust1[57][3] = -0.0244;  // Czech Republic
        emissionsResUseSust1[61][0] = 0.2933;
        emissionsResUseSust1[61][1] = 0.1711;
        emissionsResUseSust1[61][2] = 0.0611;
        emissionsResUseSust1[61][3] = 0.0244;   // Denmark
        emissionsResUseSust1[69][0] = 0.1467;
        emissionsResUseSust1[69][1] = 0.0733;
        emissionsResUseSust1[69][2] = 0.0244;
        emissionsResUseSust1[69][3] = 0.0122;   // Estonia
        emissionsResUseSust1[71][0] = 0.1467;
        emissionsResUseSust1[71][1] = 0.1222;
        emissionsResUseSust1[71][2] = 0.0611;
        emissionsResUseSust1[71][3] = 0.0244;   // Finland
        emissionsResUseSust1[74][0] = 0.1467;
        emissionsResUseSust1[74][1] = 0.0978;
        emissionsResUseSust1[74][2] = 0.0489;
        emissionsResUseSust1[74][3] = 0.0000;   // France
        emissionsResUseSust1[58][0] = 0.4400;
        emissionsResUseSust1[58][1] = 0.2200;
        emissionsResUseSust1[58][2] = 0.1467;
        emissionsResUseSust1[58][3] = 0.0244;   // Germany
        emissionsResUseSust1[87][0] = 0.0733;
        emissionsResUseSust1[87][1] = 0.0000;
        emissionsResUseSust1[87][2] = 0.0244;
        emissionsResUseSust1[87][3] = 0.0122;   // Greece
        emissionsResUseSust1[99][0] = 0.2200;
        emissionsResUseSust1[99][1] = 0.0978;
        emissionsResUseSust1[99][2] = 0.0611;
        emissionsResUseSust1[99][3] = 0.0122;   // Hungary
        emissionsResUseSust1[103][0] = 0.1467;
        emissionsResUseSust1[103][1] = 0.1222;
        emissionsResUseSust1[103][2] = 0.0367;
        emissionsResUseSust1[103][3] = 0.0244;  // Ireland
        emissionsResUseSust1[108][0] = 0.2200;
        emissionsResUseSust1[108][1] = 0.0978;
        emissionsResUseSust1[108][2] = 0.0733;
        emissionsResUseSust1[108][3] = 0.0244;  // Italy
        emissionsResUseSust1[130][0] = 0.2200;
        emissionsResUseSust1[130][1] = 0.1222;
        emissionsResUseSust1[130][2] = 0.0489;
        emissionsResUseSust1[130][3] = 0.0244;  // Latvia
        emissionsResUseSust1[128][0] = 0.0000;
        emissionsResUseSust1[128][1] = 0.0244;
        emissionsResUseSust1[128][2] = 0.0000;
        emissionsResUseSust1[128][3] = 0.0122;  // Lithuania
        emissionsResUseSust1[129][0] = 0.2933;
        emissionsResUseSust1[129][1] = 0.1467;
        emissionsResUseSust1[129][2] = 0.0611;
        emissionsResUseSust1[129][3] = 0.0367;  // Luxembourg
        emissionsResUseSust1[161][0] = 0.2200;
        emissionsResUseSust1[161][1] = 0.0733;
        emissionsResUseSust1[161][2] = 0.0489;
        emissionsResUseSust1[161][3] = 0.0244;  // Netherlands
        emissionsResUseSust1[162][0] = 0.2200;
        emissionsResUseSust1[162][1] = 0.1222;
        emissionsResUseSust1[162][2] = 0.0611;
        emissionsResUseSust1[162][3] = 0.0367;  // Norway
        emissionsResUseSust1[174][0] = 0.2200;
        emissionsResUseSust1[174][1] = 0.0733;
        emissionsResUseSust1[174][2] = 0.0611;
        emissionsResUseSust1[174][3] = 0.0000;  // Poland
        emissionsResUseSust1[177][0] = 0.0733;
        emissionsResUseSust1[177][1] = 0.0244;
        emissionsResUseSust1[177][2] = 0.0244;
        emissionsResUseSust1[177][3] = 0.0000;  // Portugal
        emissionsResUseSust1[183][0] = 0.0733;
        emissionsResUseSust1[183][1] = 0.0489;
        emissionsResUseSust1[183][2] = 0.0244;
        emissionsResUseSust1[183][3] = 0.0000;  // Romania
        emissionsResUseSust1[202][0] = 0.1467;
        emissionsResUseSust1[202][1] = 0.0733;
        emissionsResUseSust1[202][2] = 0.0367;
        emissionsResUseSust1[202][3] = 0.0000;  // Slovakia
        emissionsResUseSust1[203][0] = 0.0733;
        emissionsResUseSust1[203][1] = 0.0489;
        emissionsResUseSust1[203][2] = 0.0122;
        emissionsResUseSust1[203][3] = 0.0000;  // Slovenia
        emissionsResUseSust1[68][0] = 0.0733;
        emissionsResUseSust1[68][1] = 0.0244;
        emissionsResUseSust1[68][2] = 0.0244;
        emissionsResUseSust1[68][3] = 0.0000;   // Spain
        emissionsResUseSust1[204][0] = 0.2200;
        emissionsResUseSust1[204][1] = 0.1222;
        emissionsResUseSust1[204][2] = 0.0611;
        emissionsResUseSust1[204][3] = 0.0367;  // Sweden
        emissionsResUseSust1[78][0] = 0.3667;
        emissionsResUseSust1[78][1] = 0.1956;
        emissionsResUseSust1[78][2] = 0.0978;
        emissionsResUseSust1[78][3] = 0.0489;   // United Kingdom
    ...
    consteval array<array<double, 4>, numberOfCountries> initEmissionsResUseSust2() {
        ...
        emissionsResUseSust2[17][2] = 0.1100;
        emissionsResUseSust2[17][3] = 0.0122;   // Austria
        emissionsResUseSust2[20][0] = 0.5133;
        emissionsResUseSust2[20][1] = 0.1711;
        emissionsResUseSust2[20][2] = 0.1100;
        emissionsResUseSust2[20][3] = 0.0367;   // Belgium
        emissionsResUseSust2[24][0] = 0.2933;
        emissionsResUseSust2[24][1] = 0.1222;
        emissionsResUseSust2[24][2] = 0.0978;
        emissionsResUseSust2[24][3] = 0.0244;   // Bulgaria
        emissionsResUseSust2[97][0] = 0.2200;
        emissionsResUseSust2[97][1] = 0.0978;
        emissionsResUseSust2[97][2] = 0.0489;
        emissionsResUseSust2[97][3] = 0.0000;   // Croatia
        emissionsResUseSust2[57][0] = 0.8067;
        emissionsResUseSust2[57][1] = 0.3911;
        emissionsResUseSust2[57][2] = 0.2689;
        emissionsResUseSust2[57][3] = -0.0489;  // Czech Republic
        emissionsResUseSust2[61][0] = 0.7333;
        emissionsResUseSust2[61][1] = 0.4156;
        emissionsResUseSust2[61][2] = 0.1467;
        emissionsResUseSust2[61][3] = 0.0611;   // Denmark
        emissionsResUseSust2[69][0] = 0.2933;
        emissionsResUseSust2[69][1] = 0.1956;
        emissionsResUseSust2[69][2] = 0.0611;
        emissionsResUseSust2[69][3] = 0.0367;   // Estonia
        emissionsResUseSust2[71][0] = 0.3667;
        emissionsResUseSust2[71][1] = 0.2933;
        emissionsResUseSust2[71][2] = 0.1344;
        emissionsResUseSust2[71][3] = 0.0611;   // Finland
        emissionsResUseSust2[74][0] = 0.3667;
        emissionsResUseSust2[74][1] = 0.1956;
        emissionsResUseSust2[74][2] = 0.1222;
        emissionsResUseSust2[74][3] = 0.0122;   // France
        emissionsResUseSust2[58][0] = 1.0267;
        emissionsResUseSust2[58][1] = 0.5378;
        emissionsResUseSust2[58][2] = 0.3544;
        emissionsResUseSust2[58][3] = 0.0489;   // Germany
        emissionsResUseSust2[87][0] = 0.0733;
        emissionsResUseSust2[87][1] = 0.0489;
        emissionsResUseSust2[87][2] = 0.0489;
        emissionsResUseSust2[87][3] = 0.0122;   // Greece
        emissionsResUseSust2[99][0] = 0.5867;
        emissionsResUseSust2[99][1] = 0.2444;
        emissionsResUseSust2[99][2] = 0.1222;
        emissionsResUseSust2[99][3] = 0.0244;   // Hungary
        emissionsResUseSust2[103][0] = 0.3667;
        emissionsResUseSust2[103][1] = 0.2689;
        emissionsResUseSust2[103][2] = 0.0978;
        emissionsResUseSust2[103][3] = 0.0489;  // Ireland
        emissionsResUseSust2[108][0] = 0.5133;
        emissionsResUseSust2[108][1] = 0.2444;
        emissionsResUseSust2[108][2] = 0.1833;
        emissionsResUseSust2[108][3] = 0.0367;  // Italy
        emissionsResUseSust2[130][0] = 0.5133;
        emissionsResUseSust2[130][1] = 0.2933;
        emissionsResUseSust2[130][2] = 0.1100;
        emissionsResUseSust2[130][3] = 0.0489;  // Latvia
        emissionsResUseSust2[128][0] = 0.0733;
        emissionsResUseSust2[128][1] = 0.0244;
        emissionsResUseSust2[128][2] = 0.0244;
        emissionsResUseSust2[128][3] = 0.0000;  // Lithuania
        emissionsResUseSust2[129][0] = 0.7333;
        emissionsResUseSust2[129][1] = 0.3667;
        emissionsResUseSust2[129][2] = 0.1467;
        emissionsResUseSust2[129][3] = 0.0611;  // Luxembourg
        emissionsResUseSust2[161][0] = 0.5133;
        emissionsResUseSust2[161][1] = 0.1711;
        emissionsResUseSust2[161][2] = 0.1222;
        emissionsResUseSust2[161][3] = 0.0489;  // Netherlands
        emissionsResUseSust2[162][0] = 0.4400;
        emissionsResUseSust2[162][1] = 0.3178;
        emissionsResUseSust2[162][2] = 0.1589;
        emissionsResUseSust2[162][3] = 0.0856;  // Norway
        emissionsResUseSust2[174][0] = 0.5133;
        emissionsResUseSust2[174][1] = 0.1467;
        emissionsResUseSust2[174][2] = 0.1589;
        emissionsResUseSust2[174][3] = 0.0000;  // Poland
        emissionsResUseSust2[177][0] = 0.1467;
        emissionsResUseSust2[177][1] = 0.0733;
        emissionsResUseSust2[177][2] = 0.0611;
        emissionsResUseSust2[177][3] = 0.0122;  // Portugal
        emissionsResUseSust2[183][0] = 0.2200;
        emissionsResUseSust2[183][1] = 0.0978;
        emissionsResUseSust2[183][2] = 0.0489;
        emissionsResUseSust2[183][3] = 0.0122;  // Romania
        emissionsResUseSust2[202][0] = 0.3667;
        emissionsResUseSust2[202][1] = 0.1711;
        emissionsResUseSust2[202][2] = 0.0856;
        emissionsResUseSust2[202][3] = 0.0122;  // Slovakia
        emissionsResUseSust2[203][0] = 0.2200;
        emissionsResUseSust2[203][1] = 0.0978;
        emissionsResUseSust2[203][2] = 0.0489;
        emissionsResUseSust2[203][3] = 0.0000;  // Slovenia
        emissionsResUseSust2[68][0] = 0.1467;
        emissionsResUseSust2[68][1] = 0.0489;
        emissionsResUseSust2[68][2] = 0.0611;
        emissionsResUseSust2[68][3] = 0.0122;   //	Spain
        emissionsResUseSust2[204][0] = 0.4400;
        emissionsResUseSust2[204][1] = 0.3178;
        emissionsResUseSust2[204][2] = 0.1589;
        emissionsResUseSust2[204][3] = 0.0856;  // Sweden
        emissionsResUseSust2[78][0] = 0.8800;
        emissionsResUseSust2[78][1] = 0.4889;
        emissionsResUseSust2[78][2] = 0.2322;
        emissionsResUseSust2[78][3] = 0.1100;   // United Kingdom
        return emissionsResUseSust2;
    }
}
